...
## HARDCODING PARAMETERS TO RUN LATER QUICKER USING THE UNITY PROCESS ENGINE WITHOUT GIVING
## ARGUMENTS OR PARAMETERS

# python.exe "CyKITv2.py" localhost 18000 5 info+nocounter+format-0+generic
...
def main(CyINIT):
    ...
    if CyINIT == 2:
        ...
        print '@CyKITv2 -- eeg.EEG just intialized'

        for t in threading.enumerate():
            print str(t.getName())
        print '@CyKITv2 -- these are all threads running'
    ...
    while CyINIT > 2:
        ...
        if CyINIT > 1000:
            ...
            if myi.getOpenvibe() == True:
                if check_threads == 0:
                    ioTHREAD.onClose()
                    print "@CyKITv2 -- getOpenvibe() == True"
                    print "*** Reseting . . ."
                    CyINIT = 1
                    main(1)
                continue
